...
<div class="col-sm-10"><?php //$s=$this->uri->segment(4);?>
    <form method="post" action="<?php echo base_url(); ?>superadmin/slider/add_slider" enctype="multipart/form-data" onsubmit=" return validate_care();">
        <div class="col-sm-12">
  ...
  <div class="bg-site col-wh col-sm-12 head-pad hgh-40"> 
    ...
    <h5 class="m-t-n6" style="margin-bottom: -4px;">Add slider</h5> 
 ...
 <div class="clearfix">&nbsp;</div>
  ...
  <input type="text"  id="url" name="url" value="<?php echo set_value('url');?>" <?php if(form_error('url')!=""){echo "class='error1 form-control input-md'";}else{ echo 'class="form-control no-bod-rad"';} ?> >
...
<div class="form-group col-sm-6">
  ...
  <input type="text"  id="caption" name="caption" value="<?php echo set_value('caption');?>" <?php if(form_error('caption')!=""){echo "class='error1 form-control input-md'";}?> class="form-control no-bod-rad">
