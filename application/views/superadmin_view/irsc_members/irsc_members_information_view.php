					...
					foreach($members as $member){
						...
						<tr>
							<td><div class="form-check m-t-n15">
							    <label class="form-check-label">
								    <input type="checkbox" class="form-check-input cnames" name="cnames[]" value="<?php echo $member->id;?>" >
									</label>
								</div></td>
							<td><?php echo $c;?></td>
							...
							<td><?php echo $member->status;
				   			if($member->status==1){
				   				?>
				   				<a  href="<?php echo base_url();?>admin/posts/update_post/<?php echo $member->id; ?>/<?php echo $member->status; ?>/<?php echo $si;?>" class="badge badge-success">Active</a>
				   				<?php
				   			}
				   			else{
				   				?>
				   				<a  href="<?php echo base_url();?>admin/posts/update_post/<?php echo $member->id;?>/<?php echo $member->status;?>/<?php echo $si;?>" class="badge badge-danger">Inactive</a>
				   				<?php
				   			}
				   			?></td>
							<td>
							</a>&nbsp;<a title="Delete" onclick="javascript:return confirm('Are you sure to delete');" href="<?php echo base_url();?>admin/posts/delete_post/<?php echo $member->id;?>/<?php echo $si;?>"><i class="fa fa-trash text-danger" aria-hidden="true" ></i></a> &nbsp;</td>
        				</tr>
						<?php
						$c=$c+1;
					}
