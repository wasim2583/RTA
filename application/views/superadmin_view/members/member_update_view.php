    ...
    <div class="row">
     <?php $this->load->view('superadmin_view/includes/sidebar_view');?>
        <div class="col-sm-10">
          ...
          <form method="post" id="form" action="<?php echo HTTP_BASE_PATH;?>admin/members/update_member/<?php echo $row['group_id'];?>/<?php echo $s;?>">
            <div class="col-sm-12">
                <div class="row m-t-15" style="margin-right: 0px;">
                    <div class="bg-site col-wh col-sm-12 head-pad hgh-40"> 
						<h5 class="m-t-n6" style="margin-bottom: 0px;">Group Update View</h5>  
						<button type="submit" class="btn btn-primary btn-sm no-bod-rad pull-right" name="managegroup" style="margin-top: -20px;">
						<i class="fa fa-dot-circle-o" aria-hidden="true"></i> Manage Group</button>		
					</div>
                    <div class="col-sm-12 bg-light inventory">
                        ...
                        <div class="table-responsive col-sm-12 font14">
							...
							<div class="form-group col-sm-4">
								<label for="usr">Group Mobile:</label>
