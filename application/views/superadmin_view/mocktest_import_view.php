...
<div class="col-sm-10">
 <?php //$si=$this->uri->segment(4);?>
    <form method="post" action="<?php echo HTTP_BASE_PATH;?>superadmin/import_mocktest_controller/uploadData" enctype="multipart/form-data" >
        <div class="col-sm-12">
 ...
 <button type="submit" class="btn btn-primary btn-sm no-bod-rad pull-right" name="managemocktest" style="margin-top: -20px;"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Manage Faqs</button>		
        </div>
