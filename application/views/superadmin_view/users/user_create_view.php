                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input type="text"  maxlength="10" id="mobile" name="mobile" value="<?php echo set_value('mobile');?>" <?php if(form_error('mobile')!=""){echo "class='error1 form-control input-md'";}else{ echo 'class="form-control no-bod-rad"';} ?> >
                        <?php echo form_error('mobile', '<span  class="error ">','</span>');?> <span class="" id="mobile_err" style="color:red"></span>
                      </div>
                      
                      <div class="form-group col-sm-6">
                        <label for="location">Location:</label>
                        <select class="form-control od-rad" name="location" id="location" <?php if(form_error('location')!=""){echo "class='error1 form-control input-md'";}else{ echo 'class="form-control no-bod-rad"';} ?>>
                          ...
                          if( ! empty($locations))
                          {
                            ...
                            {
                              ?>
                          <option value="<?php echo $loc->id; ?>" <?php echo (set_value('location') == $loc->id) ? 'SELECTED' : ''; ?>>
                        ...
                        <span class="" id="location_err" style="color:red"></span>
                      </div>
                      
                      <div class="form-group col-sm-6">
                        <label for="designation">Designation:</label>
                        <select class="form-control od-rad" id="designation" name="designation" <?php if(form_error('designation')!=""){echo "class='error1 form-control input-md'";}else{ echo 'class="form-control no-bod-rad"';} ?>>
                          ...
                          if( ! empty($roles))
                          {
                            ...
                            {
                              ?>
                          <option value="<?php echo $role->id; ?>" <?php echo (set_value('designation') == $role->id) ? 'SELECTED' : ''; ?>><?php echo $role->role_name; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <?php echo form_error('designation', '<span  class="error ">','</span>');?>
                      </div>
                      <div class="form-group col-sm-6">
...
/*
  ...
  var regEx = /^[a-zA-Z]+[a-zA-Z_.,!@#*() ]+$/;
  	var vlocation=regEx.test(location);
  	if(!vlocation){
  		flag = false;
  		 $("#location_err").html("Please enter valid location");
  	 $("#location").css("border","1px solid red");
   ...
   {
  	 flag = false;
  	 $("#password_err").html("Please enter user password");
