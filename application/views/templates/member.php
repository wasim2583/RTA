...
<html lang="en">
   <head>
      ...
      <title><?php echo empty($title) ? 'Member Dashboard' : $title; ?></title>
   ...
   <body id="page-top" class="mem_prof">
      ...
      <div id="wrapper">
         ...
         <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url().'user/Member/profile'; ?>">
               <i class="fas fa-fw fa-tachometer-alt"></i>
               <span>Profile</span></a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url().'user/Member/events'; ?>">
               <i class="fa fa-id-card" aria-hidden="true"></i>
               <span>Events</span></a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url().'user/Member/offers'; ?>">
               <i class="fa fa-id-card" aria-hidden="true"></i>
               <span>Offers</span></a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
               <a class="nav-link" href="<?php echo base_url().'user/Member/member_dl'; ?>">
               <i class="fa fa-id-card" aria-hidden="true"></i>
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <?php
                  if($segment == 'events' OR $segment == 'offers')
                  {
                     ?>
                  <!-- Topbar Search -->
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <a class="btn btn-primary" href="<?php echo base_url(); ?>user/Member/logout">Logout</a>
               </div>
            </div>
         </div>
      </div>
