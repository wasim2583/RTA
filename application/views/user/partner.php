            ...
            <div class="col-lg-4 col-md-4  offset-lg-4">
               ...
               <div class="find-location">
                  <table class="table table-sm">
                     <thead>
                        <tr>
                           <th scope="col" colspan="2">Partner Profile</th>
                           <th scope="col" colspan="2"><img src="<?php echo base_url(); ?>rta_assets/profile_pics/<?php echo $partner->profile_pic; ?>" height="100"></th>
                        </tr>
                     </thead>
                     <tbody>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td><?php echo $partner->location_name; ?></td>
                        </tr>
                        <tr>
                           <th scope="row">State</th>
                           <td><?php echo $partner->state_name; ?></td>
                        </tr>
                        <tr>
