      ...
      <div class="container-fluid">
         <div class="row text-center">
            <div class="col-lg-4 col-md-4  offset-lg-4">
               ...
               <span class="btm_text">Indian Road safety Club Partnership</span>
               <div class="find-location">
                  ...
                  <div class="Reg_link"><span>Already Registered? </span><a href="<?php echo base_url().'user/Partner/login'; ?>">Login</a></div>
               </div>
            </div>
         </div>
      </div>
