         ...
         <div class="row text-center">
            <div class="col-lg-4 col-md-4  offset-lg-4">
               ...
               <div class="find-location">
                  <form action="<?php echo base_url(); ?>user/Partner/registration" method="POST" enctype="multipart/form-data">
                     <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row Member_labels">
                           <div class="col-lg-4 lableTxt">Organisation Name</div>
                           <div class="col-lg-8">
                              <input type="text" class="form-control" name="organization_name" id="organization_name" placeholder="Organisation Name" value="<?php echo set_value('organization_name'); ?>">
                           </div>
                           <div>
