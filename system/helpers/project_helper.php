...
/* Function for checking blood group*/
if ( ! function_exists('blood_check'))
{
    function blood_check($input){
        
        return $output=((preg_match('/^(A|B|AB|O)[+-]$/', $input))) ? 1:0;
    }
}
...
if ( ! function_exists('gst_check'))
{
	function gst_check($input){

		return $output=((preg_match('/^[0-9]{2}[a-zA-Z0-9]{13}$/', $input))) ? 1:0;
	}
}
